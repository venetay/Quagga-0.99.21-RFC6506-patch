...
/* babeld vty socket */
#define BABEL_VTYSH_PATH "/usr/local/var/state/quagga/babeld.vty"

/* bgpd vty socket */
#define BGP_VTYSH_PATH "/usr/local/var/state/quagga/bgpd.vty"
...
#define DAEMON_VTY_DIR "/usr/local/var/state/quagga"
...
/* isisd vty socket */
#define ISIS_VTYSH_PATH "/usr/local/var/state/quagga/isisd.vty"
...
/* ospf6d vty socket */
#define OSPF6_VTYSH_PATH "/usr/local/var/state/quagga/ospf6d.vty"

/* ospfd vty socket */
#define OSPF_VTYSH_PATH "/usr/local/var/state/quagga/ospfd.vty"
...
/* babeld PID */
#define PATH_BABELD_PID "/usr/local/var/state/quagga/babeld.pid"

/* bgpd PID */
#define PATH_BGPD_PID "/usr/local/var/state/quagga/bgpd.pid"

/* isisd PID */
#define PATH_ISISD_PID "/usr/local/var/state/quagga/isisd.pid"

/* ospf6d PID */
#define PATH_OSPF6D_PID "/usr/local/var/state/quagga/ospf6d.pid"

/* ospfd PID */
#define PATH_OSPFD_PID "/usr/local/var/state/quagga/ospfd.pid"

/* ripd PID */
#define PATH_RIPD_PID "/usr/local/var/state/quagga/ripd.pid"

/* ripngd PID */
#define PATH_RIPNGD_PID "/usr/local/var/state/quagga/ripngd.pid"

/* watchquagga PID */
#define PATH_WATCHQUAGGA_PID "/usr/local/var/state/quagga/watchquagga.pid"

/* zebra PID */
#define PATH_ZEBRA_PID "/usr/local/var/state/quagga/zebra.pid"
...
/* ripng vty socket */
#define RIPNG_VTYSH_PATH "/usr/local/var/state/quagga/ripngd.vty"

/* rip vty socket */
#define RIP_VTYSH_PATH "/usr/local/var/state/quagga/ripd.vty"
...
/* zebra api socket */
#define ZEBRA_SERV_PATH "/usr/local/var/state/quagga/zserv.api"

/* zebra vty socket */
#define ZEBRA_VTYSH_PATH "/usr/local/var/state/quagga/zebra.vty"
